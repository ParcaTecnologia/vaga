    ...
    <div className='flex flex-col  mt-8 '>
      ...
      <div className='flex items-center justify-center my-5'>
        ...
        <input
          ...
          className="border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring focus:border-blue-300 transition-all duration-300 flex-grow bg-slate-950 text-white"
          ref={user}
        />
        <button
          onClick={FindUser}
